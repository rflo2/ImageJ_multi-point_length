...
How to use :
1. draw the point with the multipoint tool to follow a structure in 2D or 3D
2. run the script. It will add the poitns to the ROI manager (for saving), add the mesurement to results table and delete the points from the image
